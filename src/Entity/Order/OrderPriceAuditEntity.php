...
use App\Ordering\Repository\Order\OrderPriceAuditRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: OrderPriceAuditRepository::class)]
#[ORM\Table(name: 'order_price_audit')]
class OrderPriceAuditEntity
{
    ...
    #[ORM\Column(name: 'grand_total', type: 'decimal', precision: 12, scale: 2, options: ['default' => '0.00'])]
