...
final class OrderDlqRequeueCommand extends Command
{
    public function __construct(private readonly ReceiverInterface $failed, private readonly SenderInterface $async)
    {
        parent::__construct();
    }
