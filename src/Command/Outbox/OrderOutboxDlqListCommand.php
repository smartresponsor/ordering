...
use App\Ordering\CommandInterface\Console\Order\OrderOutboxDlqListCommandInterface;
...
#[AsCommand(name: 'order:outbox:dlq:list', description: 'List dead outbox messages (DLQ)')]
class OrderOutboxDlqListCommand extends Command implements OrderOutboxDlqListCommandInterface
{
